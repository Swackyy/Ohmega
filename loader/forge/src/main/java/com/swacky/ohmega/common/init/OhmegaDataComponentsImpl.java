...
public final class OhmegaDataComponentsImpl implements OhmegaDataComponents.Service {
    ...
    public static final RegistryObject<DataComponentType<Boolean>> ACTIVE = register(ACTIVE_KEY, OhmegaDataComponents::createActive);
    public static final RegistryObject<DataComponentType<Integer>> SLOT_INDEX = register(SLOT_INDEX_KEY, OhmegaDataComponents::createSlotIndex);
