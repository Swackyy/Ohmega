 ...
 * <p>
 * Cancelling only cancels overrides of {@link IAccessory#onUnequip(Entity, ItemStack)} and does not stop the accessory from being equipped;
 * Instead, to achieve such behaviour, use {@link AccessoryCanUnequipEvent}
 */
public record AccessoryUnequipEvent(Entity entity, ItemStack stack) implements RecordEvent, Cancellable {
