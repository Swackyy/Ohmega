...
abstract class Forge_InventoryScreenMixin extends AbstractRecipeBookScreen<InventoryMenu> {
    public Forge_InventoryScreenMixin(InventoryMenu menu, RecipeBookComponent<?> recipeBook, Inventory inventory, Component title) {
