...
public final class OhmegaItemsImpl implements OhmegaItems.Service {
    ...
    private static <T extends Item> RegistryObject<T> register(String id, Function<Item.Properties, T> function, Supplier<Item.Properties> sup) {
        return ITEMS.register(id, () -> function.apply(sup.get().setId(ResourceKey.create(Registries.ITEM, Ohmega.id(id)))));
    }
