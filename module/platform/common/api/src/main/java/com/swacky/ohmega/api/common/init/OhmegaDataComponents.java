...
public final class OhmegaDataComponents {
    ...
    public static DataComponentType<Boolean> createActive() {
    ...
    public static DataComponentType<ItemAttributeModifiers> createItemAttributeModifiers() {
    ...
    public static DataComponentType<Integer> createSlotIndex() {
