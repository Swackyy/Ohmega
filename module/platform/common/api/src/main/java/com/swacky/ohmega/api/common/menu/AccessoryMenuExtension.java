...
public abstract class AccessoryMenuExtension {
    ...
    /**
     * Retrieve the owner of this accessory extension's parent inventory
     ...
     * @param data the {@link AccessoryData} attached to the {@link Player} opening this menu
     * @apiNote This is only called on the logical client, whilst the server specific behaviour is handled internally by Ohmega
     */
    public abstract void addSlots(@NonNull SlotAdder adder, @NonNull AccessoryData data);
