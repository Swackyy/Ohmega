...
abstract class Forge_AbstractContainerScreenMixin<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
    private Forge_AbstractContainerScreenMixin(Component title) {
        super(title);
    }
