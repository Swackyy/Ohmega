...
public class ModBinds {
    ...
    public static final KeyMapping UTILITY_1 = new KeyMapping("key." + Ohmega.MODID + ".utility_", KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_V, CATEGORY);
